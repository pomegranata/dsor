...
package body Fire_Control is
   procedure Engage_Target (Shell : Projectile; Enemy: Target; Auth_Code : String) is
   begin
      Put_Line (" ");
      Put_Line ("========================================");
      ...
      begin
         ...
         if Auth_Code = "GHOST-ACTUAL" then
            ...
            if kinetic_energy > Enemy.armor_rating then
               Put_Line ("Missile kinetic energy is above the target's armor.");
               Put_Line ("Armor pierced. Target destroyed.");
            else
               Put_Line ("Missile kinetic energy is below the target's armor.");
